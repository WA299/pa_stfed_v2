...
from code.models.stgcn_baseline import STGCNBaseline
    ...
    for scope in ("node_macro", "grid_aggregate"):
        ...
        for metric in REPORT_METRICS:
            ...
            if np.isclose(model_value, persistence_value, rtol=1e-12, atol=1e-12):
                ...
                relation = "stgcn_lower"
            else:
                relation = "stgcn_higher"
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    for method, result in (("STGCN", report["validation"]["stgcn"]), ("Persistence 1h", report["validation"]["persistence_1h"])):
        for scope in ("node_macro", "grid_aggregate"):
            values = result[scope]
            lines.append(
